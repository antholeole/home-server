...
export interface OrphanSpec {
   ...
   * Can be "v1", "v2".
   *
   * @schema OrphanSpec#dataEngine
   */
  readonly dataEngine?: OrphanSpecDataEngine;
 ...
 * Can be "v1", "v2".
 *
 * @schema OrphanSpecDataEngine
 */
export enum OrphanSpecDataEngine {
  /** v1 */
  V1 = "v1",
  /** v2 */
  V2 = "v2",
...
export enum RecurringJobV1Beta2SpecTask {
  ...
  /** system-backup */
  SYSTEM_HYPHEN_BACKUP = "system-backup",
}
...
export interface VolumeV1Beta2Spec {
   ...
   *
   * @schema VolumeV1Beta2Spec#offlineRebuilding
   */
  readonly offlineRebuilding?: VolumeV1Beta2SpecOfflineRebuilding;
...
export function toJson_VolumeV1Beta2Spec(obj: VolumeV1Beta2Spec | undefined): Record<string, any> | undefined {
  ...
  const result = {
    ...
    'offlineRebuilding': obj.offlineRebuilding,
 ...
 * - disabled: Disable offline rebuilding for this volume, regardless of the global setting
 *
 * @schema VolumeV1Beta2SpecOfflineRebuilding
 */
export enum VolumeV1Beta2SpecOfflineRebuilding {
  /** ignored */
  IGNORED = "ignored",
  /** disabled */
  DISABLED = "disabled",
