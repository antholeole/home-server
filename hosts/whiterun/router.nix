{
  ...
  lan-if = "wlo1";
in {
  environment.systemPackages = with pkgs; [iw wirelesstools lshw];
  ...
  boot = {
    ...
    # enable the antannae
    extraModprobeConfig = "optionsiwlwifi 11n_disable=8";
  };
  ...
  services.hostapd = {
    ...
    radios = {
      ...
      ${lan-if} = {
        ...
        settings = {
          hw_mode = "a"; # 5ghz
          noscan = lib.mkForce true;

          ieee80211n = true;
          ieee80211ac = true;

          # center around channels
          vht_oper_centr_freq_seg0_idx = 157;
          he_oper_centr_freq_seg0_idx = 157;
